  ...
  return (
    <CommonWhiteContainer style={styles.container}>
      ...
      <View style={styles.infoContainer}>
        ...
        <ProfileInfo label={t("setting.fullName")} value={user?.fullName} />
        <ProfileInfo label={t("setting.gender")} value={t("setting." + user?.gender)} />
        <ProfileInfo label={t("setting.birthDate")} value={user?.birthDate} />
        <ProfileInfo label={t("setting.phoneNumber")} value={user?.phoneNumber} />

        {isCurrentUser && (
          <>
            <PrimaryButton
              title={t("setting.changeProfile")}
